        ...
        if (resultItems != null && resultItems.getAll().size() > 0) {
            ...
            for (int i = 0; i < names.size(); i++) {
                ...
                try{
                    ...
                    long commentl = StringUtils.isNotEmpty(commentstr)?(commentstr.replace("+","").contains("万")?Long.valueOf(commentstr.replace("+","").replace("万",""))*1000:Long.valueOf(commentstr.replace("+","").replace("万",""))):0;
